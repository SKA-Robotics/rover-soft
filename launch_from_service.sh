...
modprobe -r uvcvideo
echo 200 | sudo tee /sys/module/uvcvideo/parameters/bandwidth_cap
...
TERM=xterm-256color tmux new-session -d -s ros -n nodes "bash -l -i -c \"source /home/rover/rover-soft/devel/setup.bash; roslaunch sirius_description sirius2.launch\"; bash -i"
