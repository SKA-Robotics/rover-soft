<template>
    <div class="home">
        <img
            alt="SKA logo"
            src="../assets/SKAR_logo_EN_color-cropped.svg"
            style="margin-top: 110px; margin-bottom: 30px; width: 300px"
        />
        <h1>Sirius II Control Panel</h1>
        <ConnectionForm
            v-if="!this.connected"
            @form-submitted="connect($event)"
        />
        <HomeConnected
            v-else
        ...
        <label class="warning" v-if="this.connection_error">
            ...
            <details class="help">
                ...
                <ul>
                    ...
                    <li>
                        Check if you are connected to the same network as the
                        rover
                    </li>
                </ul>
            </details>
        ...
        <label class="warning" v-if="this.address_error">
            ...
            <details class="help">
                ...
                <ul>
                    <li>
                        Valid address should look similiar to this:
                        <i>ws://192.168.21.37:9090</i>
                    </li>
                </ul>
            </details>
        </label>
