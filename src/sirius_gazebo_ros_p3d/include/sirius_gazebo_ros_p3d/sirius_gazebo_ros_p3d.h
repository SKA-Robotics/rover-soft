...
namespace gazebo
{
  class SiriusGazeboRosP3D : public ModelPlugin
  {
    /// \brief Constructor
    public: SiriusGazeboRosP3D();

    /// \brief Destructor
    public: virtual ~SiriusGazeboRosP3D();
    ...
    /// \brief allow specifying constant xyz and rpy offsets for parent frame
    private: ignition::math::Pose3d frame_offset_;
